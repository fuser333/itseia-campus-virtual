    ...
    <div className="min-h-screen bg-[#0A1628] font-sans overflow-x-hidden">
      ...
      <PublicHeader />
        ...
        <div className="text-center py-4 px-4 bg-gradient-to-r from-[#FBBC0C]/10 via-[#FBBC0C]/15 to-[#FBBC0C]/10 border-b border-[#FBBC0C]/20">
          <a href="/login?module=cursos-pro" className="inline-flex items-center gap-3 group">
            ...
            <span className="text-[#FBBC0C] font-bold text-sm sm:text-base group-hover:underline">Accede a tus Cursos Profesionales →</span>
          </a>
        </div>
