    ...
    <div className="min-h-screen bg-[#0A1628] font-sans overflow-x-hidden">
      ...
      <PublicHeader />
        ...
        <div className="text-center py-4 px-4 bg-gradient-to-r from-[#FBBC0C]/10 via-[#FBBC0C]/15 to-[#FBBC0C]/10 border-b border-[#FBBC0C]/20">
          <a href="/login?module=docentes" className="inline-flex items-center gap-3 group">
            ...
            <span className="text-[#FBBC0C] font-bold text-sm sm:text-base group-hover:underline">Accede al panel docente →</span>
          </a>
        </div>
        {/* Login access — prominent banner */}
        <div className="text-center py-4 px-4 bg-gradient-to-r from-[#F0846D]/10 via-[#F0846D]/15 to-[#F0846D]/10 border-b border-[#F0846D]/20">
          <a href="/login?module=docentes" className="inline-flex items-center gap-3 group">
            <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#F0846D]/20 group-hover:bg-[#F0846D]/30 transition-colors">
              <svg className="w-4 h-4 text-[#F0846D]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
            </span>
            <span className="text-white font-semibold text-sm sm:text-base">¿Eres docente ITSEIA?</span>
            <span className="text-[#F0846D] font-bold text-sm sm:text-base group-hover:underline">Accede al panel docente →</span>
          </a>
        </div>
