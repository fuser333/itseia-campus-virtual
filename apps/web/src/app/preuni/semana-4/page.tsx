...
import { BookOpen, Play, CheckCircle2, Clock, ChevronRight, Sparkles } from "lucide-react";

const WEEK_NUMBER = 4;

export default async function PreuniSemana4() {
  ...
  const isWeekComplete = totalSessions > 0 && completedCount === totalSessions;
    ...
    <div style={{ color: "#1F2F58" }}>
      ...
      <div className="mb-8">
        ...
        <div className="flex items-start gap-4 mt-3">
          ...
          >
            <Sparkles className="w-6 h-6" style={{ color: "#FBBC0C" }} />
          </div>
          <div className="flex-1">
            <h1
              ...
              style={{ color: "#0A1628" }}
            >
              Semana {WEEK_NUMBER}: {semester.name || "Proyecto Final"}
            </h1>
            <p className="mt-1 text-sm" style={{ color: "#1F2F58AA" }}>
              {subjects.length} materia{subjects.length !== 1 ? "s" : ""} &middot;{" "}
              {totalSessions} sesion{totalSessions !== 1 ? "es" : ""} &middot; Semana final
            </p>
          </div>
        </div>
          ...
          >
            ...
            <div>
              <p className="text-sm font-bold" style={{ color: "#16a34a" }}>
                Completaste el Preuniversitario ITSEIA
              </p>
              <p className="text-xs mt-0.5" style={{ color: "#16a34a99" }}>
                Has finalizado todas las sesiones. Revisa tus certificados en tu perfil.
              </p>
            </div>
          </div>
        )}
      ...
      <div className="mt-10 flex items-center justify-between">
        ...
        <Link
          ...
          style={{ backgroundColor: "#1F2F58", color: "#FBBC0C" }}
        >
          Ver Certificados
