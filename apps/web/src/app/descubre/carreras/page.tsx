      ...
      <main className="relative z-10 max-w-6xl mx-auto px-5 py-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-14">
          {[
            ...
            { value: "6", label: "Semestres de formación" },
        ...
        {/* ── Qué incluye ── */}
        <section className="mb-14">
          <div className="rounded-2xl border border-[#FBBC0C]/20 p-8" style={{ background: "linear-gradient(145deg, rgba(251,188,12,0.06) 0%, rgba(31,47,88,0.25) 100%)", backdropFilter: "blur(12px)" }}>
            <h2
              className="text-2xl font-extrabold text-white mb-6 text-center"
              style={{ fontFamily: "var(--font-space-grotesk)" }}
            >
              Qué incluye tu carrera
            </h2>
            <div className="grid sm:grid-cols-2 gap-3">
              {[
                ...
                "Proyectos reales en empresas del ecosistema",
                "Acceso de por vida a los materiales del programa",
              ].map((item) => (
        ...
        <section className="mb-14">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {/* Online */}
            <div className="rounded-2xl border border-[#73B8E7]/30 p-7 text-center" style={{ background: "linear-gradient(145deg, rgba(115,184,231,0.08) 0%, rgba(31,47,88,0.25) 100%)", backdropFilter: "blur(12px)" }}>
              ...
              <div className="text-white/35 text-sm line-through mb-1">Antes $300/mes</div>
              <div className="text-[#73B8E7] text-5xl font-extrabold mb-1" style={{ fontFamily: "var(--font-space-grotesk)" }}>$99</div>
              <div className="text-white/50 text-sm mb-4">/mes · 3 años</div>
              <div className="text-white/40 text-xs">+ Inscripción $49 (única vez)</div>
            </div>
            {/* Presencial */}
            <div className="rounded-2xl border border-[#FBBC0C]/30 p-7 text-center" style={{ background: "linear-gradient(145deg, rgba(251,188,12,0.08) 0%, rgba(31,47,88,0.25) 100%)", backdropFilter: "blur(12px)" }}>
              <div className="inline-flex items-center gap-2 bg-[#FBBC0C]/10 border border-[#FBBC0C]/20 rounded-full px-3 py-1.5 mb-4">
                <span className="text-[#FBBC0C] text-xs font-bold uppercase tracking-wider">TITAN — Presencial Quito</span>
              </div>
              <div className="text-white/35 text-sm line-through mb-1">Antes $300/mes</div>
              <div className="text-[#FBBC0C] text-5xl font-extrabold mb-1" style={{ fontFamily: "var(--font-space-grotesk)" }}>$149</div>
              <div className="text-white/50 text-sm mb-4">/mes · 3 años</div>
              <div className="text-white/40 text-xs">+ Inscripción $99 (única vez)</div>
            </div>
          </div>
          <p className="text-center text-white/35 text-xs mt-4">Beca Corporativa H3L. 30 cupos disponibles. Inicio junio 2026.</p>
        </section>
