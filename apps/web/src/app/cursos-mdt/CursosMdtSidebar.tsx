...
const MENU: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { href: "/cursos-mdt/c1",  label: "C1. Intro IA Aplicada",      icon: Sparkles,       labelColor: "#73B8E7" },
      { href: "/cursos-mdt/c2",  label: "C2. Python Datos",           icon: Code2,          labelColor: "#73B8E7" },
      { href: "/cursos-mdt/c3",  label: "C3. ML Negocios",            icon: BarChart3,      labelColor: "#73B8E7" },
      { href: "/cursos-mdt/c4",  label: "C4. Big Data",               icon: Database,       labelColor: "#73B8E7" },
      { href: "/cursos-mdt/c5",  label: "C5. Gestión Proyectos IA",   icon: FolderKanban,   labelColor: "#73B8E7" },
      { href: "/cursos-mdt/c6",  label: "C6. Claude Code",            icon: Terminal,       labelColor: "#73B8E7" },
      { href: "/cursos-mdt/c7",  label: "C7. Codex",                  icon: Cpu,            labelColor: "#73B8E7" },
      { href: "/cursos-mdt/c8",  label: "C8. Antigravity",            icon: Globe,          labelColor: "#73B8E7" },
      { href: "/cursos-mdt/c9",  label: "C9. Cursor",                 icon: MousePointer2,  labelColor: "#73B8E7" },
      { href: "/cursos-mdt/c10", label: "C10. Fund. IA",              icon: Layers,         labelColor: "#73B8E7" },
      { href: "/cursos-mdt/c11", label: "C11. Fund. Ciencia Datos",   icon: PieChart,       labelColor: "#73B8E7" },
      { href: "/cursos-mdt/c12", label: "C12. Fund. Big Data",        icon: Server,         labelColor: "#73B8E7" },
      { href: "/cursos-mdt/c13", label: "C13. IA Proyectos",          icon: Rocket,         labelColor: "#73B8E7" },
      { href: "/cursos-mdt/c14", label: "C14. Ciencia Datos Aplicada",icon: FlaskConical,   labelColor: "#73B8E7" },
      { href: "/cursos-mdt/c15", label: "C15. Big Data Aplicada",     icon: Workflow,       labelColor: "#73B8E7" },
    ],
  },
  {
