...
/**
 * StubCard · Helper interno para las pestañas admin FASE 4.
 *
 * Cada pestaña real (FASE 5+) reemplaza este stub por su implementación con
 * queries reales. Mientras tanto el shell queda armado y la navegación entre
 * pestañas funciona vacía.
 */
