...
import { BookOpen, Play, CheckCircle2, Clock, ChevronRight, BarChart2 } from "lucide-react";

const WEEK_NUMBER = 2;

export default async function PreuniSemana2() {
    ...
    <div style={{ color: "#1F2F58" }}>
      ...
      <div className="mb-8">
        ...
        <div className="flex items-start gap-4 mt-3">
          ...
          >
            <BarChart2 className="w-6 h-6" style={{ color: "#FBBC0C" }} />
          </div>
          <div className="flex-1">
            <h1
              ...
              style={{ color: "#0A1628" }}
            >
              Semana {WEEK_NUMBER}: {semester.name || "Datos con IA"}
            </h1>
