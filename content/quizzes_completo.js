...
const QUIZ_DATA = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: '¿Cómo beneficia la documentación automatizada a la continuidad del cuidado?', o: opts('Solo beneficia al médico que documenta','Notas más completas y completoizadas facilitan que otros médicos entiendan el caso rápidamente','No beneficia la continuidad','Solo en hospitales privados'), exp: 'Notas completas y estructuradas reducen errores de comunicación entre turnos y especialidades.' },
    ]
  },
  {
...
async function main() {
  ...
  console.log('ITSEIA Academy — Quizzes Completo (especialista-ia-completo)');
  console.log('='.repeat(60));
